...
// Get all card names from the database
	$query = "SELECT card_name FROM " . $wpdb->prefix . YUGIOHCARDREF_TABLE_NAME .
		" WHERE card_name IS NOT NULL AND " .
 		" card_name NOT IN ('?', 'C', 'Cunning', 'Flash', 'Void', 'Reclamation', 'Revelation', 'Opt', 'Exchange', 'Greed', 'Tangle', 'Scour',  'Trap Hole',  'Dark Magician', '7', 'Fissure', 'Black Luster Soldier', 'Scapegoat', 'Honest', 'Fine', 'Shrink', 'Question', 'Card Trader', 'Toll', 'Unity', 'Reinforcements', 'Gust', 'Disappear', 'Gamble', 'Raigeki', 'Recycle', 'Contact', 'Forest', 'Intercept', 'Blocker', 'Ceasefire', 'Reasoning') " .
